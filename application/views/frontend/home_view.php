                                ...
                                <form action="#">
                                    <div class="row">
                                        <div class="col-md-3 col-lg-3">
                                            <input type="text" placeholder="Check In"  class="form-control datepicker">
                                        </div>
                                        <div class="col-md-3 col-lg-3">
                                            <input type="text" id="checkout_date" class="form-control datepicker" placeholder="Check Out">
                                        </div>
                                        ...
                                        <div class="col-md-2 col-lg-2">
                                            <!--    <button class="awe-btn awe-btn-13">Check Availabilty</button>
                                            </div> -->
                            ...
                            <div class="col-sm-3 col-md-3 col-lg-3">
                                <div class="room-compare_item">
                                    ...
                                    <div class="text">
                                        ...
                                        <ul>
                                            <h4><?php
                                                $has = $this->db->get_where('room_price', array('kd_compare' => $j->kd_compare))->last_row()->price;
