...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <meta name="author" content="nono ninii">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-star"></i><span class="sidebar-mini-hide">Room</span></a>
                                    <ul>
                                   
                                <li>
                                    <a  href="<?php echo base_url().'admin/room'?>">Room & Suite</a>
                                </li>
                                <li>
                                    <a  href="<?php echo base_url().'admin/room/data'?>">Data Room</a>
                                </li>
                                    </ul>
                                <li>
            ...
            <?php $this->load->view('admin/'.$view);?>
                ...
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Created with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="http://mfikri.com" target="_blank">nono ninii</a>
                    </div>
                    <div class="float-left">
                        <a class="font-w600" href="https://mfikri.com" target="_blank">nono</a> &copy; <span class="js-year-copy"><?php echo date('Y');?></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
